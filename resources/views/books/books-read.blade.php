<x-layout>
    ...
    <div class="flex items-center space-x-[1rem]">
        <input type="text"
            class="w-full max-w-[280px] bg-[#AD49E1] rounded-md p-[0.4rem] px-[0.8rem] text-white outline-none"
            placeholder="Search book...">
        <button class="bg-[#EBD3F8] rounded-md py-[0.4rem] px-[0.8rem] cursor-pointer">Search</button>
    </div>
    ...
    <button class="fixed right-12 bottom-12 rounded-full p-[0.5rem] font-semibold bg-[#2E073F]">
